...
//+kubebuilder:rbac:groups=cms.wellcom.rocks,resources=wordpresses,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=cms.wellcom.rocks,resources=wordpresses/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=cms.wellcom.rocks,resources=wordpresses/finalizers,verbs=update
